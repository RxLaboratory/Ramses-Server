<?php
    ...
    */
    ...
    function unassignUsers($users, $projectUuid) {
        global $log, $reply;
        ...
        $q->unassignUsers($userIds, $projectId);

        $reply["message"] = "Users unassigned!";
        $reply["success"] = true;
        printAndDie();
    }
    ...
    if ( acceptReply( "unassignUser" ) )
    {
        ...
        unassignUsers([$userUuid], $projectUuid);
    }

    if ( acceptReply( "unassignUsers" ) )
    {
        if (!isAdmin())
        {
            $reply["success"] = false;
        ...
        unassignUsers($users, $projectUuid);
    }
