...
def get_api_build_path(name="Adobe Script"):
    """!
    ...
    return os.path.join(
        get_build_path(name),
        get_project_name() + "_API"
    )

def get_jsx_build_path(name="Adobe Script"):
    """!
...
def build_api(name="Adobe Script"):
    ...
    build_path = get_api_build_path(name)
...
def build_scripts(name="Adobe Script"):
    """Builds all end-user scripts"""

    print("> Building Scripts...")

    build_path = os.path.join(
        get_jsx_build_path(name),
        "Scripts"
    )
...
def build_scriptUI(name="Adobe Script"):
    """Builds all end-user scripts"""
