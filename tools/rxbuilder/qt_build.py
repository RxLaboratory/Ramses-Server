...
def get_qt_build_path(name:str, debug=False):
    """!
...
def build(name="Application", debug=False):
    """!
    @brief Builds DuGit
    ...
    build_path = get_qt_build_path(name)
...
def wipe(name="Application",debug=False):
    """!
